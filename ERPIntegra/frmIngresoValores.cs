...
{
    public partial class frmIngresoValores : Form
    {
        csConexion c = new csConexion();
        public frmIngresoValores()
        {
            InitializeComponent();
        }
        ...
        private void frmIngresoValores_Load(object sender, EventArgs e)
        {
        ...
        private void frmIngresoValores_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            if (txtTotal.Text == "")
            {
                MessageBox.Show("Debe ingresar el valor");
            }
            else
            {
